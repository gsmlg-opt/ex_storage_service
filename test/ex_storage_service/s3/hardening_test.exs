defmodule ExStorageService.S3.HardeningTest do
  ...
  describe "rate limiter" do
    test "allows requests under the limit" do
      ...
      ExStorageService.S3.Plugs.RateLimiter.ensure_table()
      ...
      result = ExStorageService.S3.Plugs.RateLimiter.call(conn, [])
