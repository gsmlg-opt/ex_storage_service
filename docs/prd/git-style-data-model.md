...
* Extend mark-and-sweep to the global CAS with candidate queue, quarantine, dry-run, audit logs, admin visibility.
* Legacy `ContentGC` retires when the legacy layout is deleted.
